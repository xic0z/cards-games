...
1. Usando o comando cond, faça com que o programa pare no ```breakpoint``` só nos casos que identificou acima;
1. Volte o correr o programa dentro do ```gdb``` com os dois casos que testou acima e verifique que ele só pára quando é necessário.
